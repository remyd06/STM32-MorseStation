...
int main(void)
{
  ...
  xTaskCreate(task_uart, "UART", 116, NULL, 7, NULL);
  xTaskCreate(task_print, "PRINT", 94, NULL, 5, NULL);
  xTaskCreate(task_encoder, "ENCODER", 160, NULL, 6, NULL);
  xTaskCreate(task_led_and_speaker, "LEDANDSPEAKER", 192, NULL, 6, &xTaskLedAndSpeakerHandle);
  xTaskCreate(task_button, "BUTTON", 80, NULL, 4, NULL);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SPEAKER_Pin|RED_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|GREEN_LED1_Pin|GREEN_LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPEAKER_Pin RED_LED_Pin */
  GPIO_InitStruct.Pin = SPEAKER_Pin|RED_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LD2_Pin GREEN_LED1_Pin GREEN_LED2_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|GREEN_LED1_Pin|GREEN_LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
